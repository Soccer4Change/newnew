...
export default function About() {
  ...
  const [cofoundersOpen, setCofoundersOpen] = useState(true);
  ...
  useEffect(() => {
    ...
    setTeam({
      members: [
        {
          name: "Vedanth Rao",
          position: "Head Coach & Software Lead",
        ...
        {
          name: "Adel Dekhani",
          position: "Administrator & Class Coordinator",
        ...
        {
          name: "Leo Tang",
          position: "Head Offensive Coach & Outreach Director",
          bio: "Leo has 13 years of competitive soccer experience. He has played over 10 years of premier level soccer. He will focus on the attacking attributes of soccer such as dribbling, finishing, and passing. Leo's main goal is to make sure his players have fun while developing their soccer skills.",
          image: "leo.webp",
        },
        {
          name: "Matthew Bronowski",
          position: "Head Defensive Coach",
        ...
        {
          name: "Maximus Burger",
          position: "Head Goalie Coach & Fundraising Coordinator",
          bio: "Max has 9 years of soccer under his belt, with 3 years of select soccer and 4 years at the premier level. He will focus on improving the skills of all goalies in a supportive environment and make sure every player has fun as they develop.",
          image: "max.webp",
        },
        {
          name: "Shivum Saha",
          position: "Photographer / Videographer",
          bio: "Shivum has 5 years of experience with videography and continues to grow by making a variety of short films and working on projects through film workshops and programs. He is a high schooler with a passion for filmmaking who hopes to make a meaningful impact with his skills.",
          image: "shivum.webp",
        },
        {
          name: "Sam Brodsky",
          position: "Defensive Coach",
          bio: "Sam brings over 10 years of soccer experience as a player and now coaches with a strong emphasis on defensive skills, tactical awareness, and team organization. Sam focuses on teaching the fundamentals of communication and smart decision-making, helping athletes grow both on and off the field.",
          image: "sam.webp",
        },
      ],
    });
  ...
  const cofounders = team?.members.filter((m) =>
    ["Vedanth Rao", "Adel Dekhani"].includes(m.name)
  );
  const teamMembers = team?.members.filter(
    (m) => !["Vedanth Rao", "Adel Dekhani"].includes(m.name)
  );
      ...
      <div className="flex flex-col gap-16 animate-fade-in">
          ...
          <div className="flex lg:flex-row flex-col justify-center gap-10">
            <div className="flex flex-col gap-4 flex-1">
              ...
              <p className="transition-opacity duration-700 opacity-80 hover:opacity-100">
                ...
                teamwork, and leadership. We seek to provide our students with mentors who can guide them 
                through soccer and their future as students as well.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 flex-1">
              ...
              <p className="transition-opacity duration-700 opacity-80 hover:opacity-100">
                ...
                while gaining a newfound passion for the sport. Additionally, we seek to provide students
                with high school mentors who can help teach and support them through their journey as students.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative h-full w-full flex flex-col justify-center items-center text-center text-white px-6">
            ...
            <h1 className="text-amber-500 font-bold text-5xl">
              Empower and mentor youth through soccer
            </h1>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-4 items-center w-full">
            <button
              onClick={() => setCofoundersOpen(!cofoundersOpen)}
              className="text-2xl font-bold text-gray-800 flex items-center gap-2"
            >
              Co-Founders {cofoundersOpen ? "▲" : "▼"}
            </button>

            {cofoundersOpen && (
              <div
                className={`flex flex-wrap justify-center gap-8 z-30 transition-all duration-1000 ${
