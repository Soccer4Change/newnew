...
import mainHomepageImage from "/public/Main Homepage Image.webp";
import whyChooseUsImage from "/public/Why Choose Us.webp";
      ...
      >
        <div className="bg-black bg-opacity-55 w-full h-full flex flex-col items-center justify-center gap-6">
          ...
          <h2 className="text-lg md:text-2xl sm:text-xl text-white max-w-[30ch] md:max-w-[65ch] sm:max-w-[45ch] text-center font-thin">
            A grant funded 501c3 nonprofit organization
          ...
          <h2 className="text-lg md:text-2xl sm:text-xl text-white max-w-[30ch] md:max-w-[65ch] sm:max-w-[45ch] text-center font-thin">
            ...
            We aim to not only provide sports coaching, but also provide high school mentors to help the next generation of athletes and students
          </h2>
          ...
          <div className="flex flex-wrap gap-x-24 gap-y-8 items-center">
            ...
            <div className="flex flex-col gap-4 flex-1 min-w-[300px]">
              ...
              <p className="max-w-[75ch]">
                ...
                well-grounded skills, taking them to the next level for their
                soccer journey and their future as students.
                <br />
                Visit the{" "}
                {/* ✅ Use Link */}
